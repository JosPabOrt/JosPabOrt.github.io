...
author:
    name: "[José Pablo Ortega Chávez](https://jospabort.github.io)"
...
[Wikipedia (2022)](https://es.wikipedia.org/wiki/Media_aritm%C3%A9tica "Wikipedia (2022)")
...
> "En la [estadística](https://es.wikipedia.org/wiki/Estad%C3%ADstica "Estadística"), la **moda** es el valor que aparece con mayor frecuencia en un conjunto de datos. Esto va en forma de una columna cuando encontremos dos modas, es decir, dos datos que tengan la misma frecuencia absoluta máxima. Una distribución trimodal de los datos es en la que encontramos tres modas. En el caso de la distribución uniforme completa, cuando todos los datos tienen una misma frecuencia, se puede definir las modas como indicado, pero estos valores no tienen utilidad. Por eso algunos matemáticos califican esta distribución como «sin moda»."
